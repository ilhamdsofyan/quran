...
<title>QuarTal | <?php echo $content_title ?></title>

<?php $this->load->view('template/css_mandatory'); ?>

<link rel="shortcut icon" href="<?php echo ROOT_URL ?>/assets/img/logomi.png">
